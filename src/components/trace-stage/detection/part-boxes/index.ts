...
const PARTS: readonly BodyPart[] = ['face', 'hand_L', 'hand_R', 'hip', 'leg_L', 'leg_R'];
...
const PART_EXPAND: Record<BodyPart, PartExpand> = {
  ...
  // The two hip landmarks are nearly horizontal; the vertical extent comes
  // mostly from the MIN_HALF floor plus this expansion.
  hip: { x: 1.4, up: 2, down: 2.4 },
