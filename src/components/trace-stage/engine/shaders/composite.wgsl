...
// enough that the overlay line work stays readable. The video keeps its
// color. No feedback/accumulation — every frame is graded fresh (scanlines,
// film grain, vignette).
...
fn fsMain(in: VSOut) -> @location(0) vec4f {
  ...
  // Dimmed color stage — visible image, but the overlay carries the look.
